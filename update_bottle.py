...
class ims_Test7(unittest.TestCase):
    ...
    def test_login(self):
        ...
        elem.click()
        time.sleep(2)
        elem = driver.find_element_by_id("id_emp_init").clear()
        elem = driver.find_element_by_id("id_emp_init")
        elem.send_keys("JTR")
        elem = driver.find_element_by_xpath("/html/body/div/div/div/div/form/div[8]/button")
        elem.click()
        time.sleep(5)
